...
function init(options) {
  ...
  var algorithm = options.algorithm || require("code42day-vis-why");
  var endPoints = options.endPoints || 25; // how many points keep at ends
  var maxPoints = options.pathPoints || 100; // maximum number of points kept per path
